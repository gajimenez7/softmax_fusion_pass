module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  ^bb9:  // pred: ^bb8
    %33 = llvm.getelementptr %arg1[%31] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %34 = llvm.load %33 : !llvm.ptr -> f32
    %35 = llvm.fsub %34, %18  : f32
    %36 = llvm.intr.exp(%35)  : (f32) -> f32
    %37 = llvm.getelementptr %arg6[%31] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %36, %37 : f32, !llvm.ptr
    %38 = llvm.add %31, %30  : i64
    llvm.br ^bb8(%38 : i64)
  ^bb10:  // pred: ^bb8
    %39 = llvm.sext %arg10 : i32 to i64
    %40 = llvm.mlir.constant(0 : index) : i64
    %41 = llvm.mlir.constant(1 : index) : i64
    llvm.br ^bb11(%40, %12 : i64, f32)
  ^bb11(%42: i64, %43: f32):  // 2 preds: ^bb10, ^bb12
    %44 = llvm.icmp "slt" %42, %39 : i64
    llvm.cond_br %44, ^bb12, ^bb13
  ^bb12:  // pred: ^bb11
    %45 = llvm.getelementptr %arg6[%42] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %46 = llvm.load %45 : !llvm.ptr -> f32
    %47 = llvm.fadd %43, %46  : f32
    %48 = llvm.add %42, %41  : i64
    llvm.br ^bb11(%48, %47 : i64, f32)
  ^bb13:  // pred: ^bb11
    %49 = llvm.sext %arg10 : i32 to i64
    %50 = llvm.mlir.constant(0 : index) : i64
    %51 = llvm.mlir.constant(1 : index) : i64
    llvm.br ^bb14(%50 : i64)
  ^bb14(%52: i64):  // 2 preds: ^bb13, ^bb15
    %53 = llvm.icmp "slt" %52, %49 : i64
    llvm.cond_br %53, ^bb15, ^bb16
  ^bb15:  // pred: ^bb14
    %54 = llvm.getelementptr %arg6[%52] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %55 = llvm.load %54 : !llvm.ptr -> f32
    %56 = llvm.fdiv %55, %43  : f32
    %57 = llvm.getelementptr %arg6[%52] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %56, %57 : f32, !llvm.ptr
    %58 = llvm.add %52, %51  : i64
    llvm.br ^bb14(%58 : i64)
  ^bb16:  // pred: ^bb14
    llvm.return
  }
