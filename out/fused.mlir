...
=== Analyzing function: softmax ===

[loop 1] MAX REDUCTION
[loop 2] EXP COMPUTE
[loop 3] SUM REDUCTION
[loop 4] DIV NORMALIZE

=== Attempting Loop Fusion ===

[fusion attempt] EXP (loop 2) + SUM (loop 3)
[info] standard fusion failed (code 1), attempting manual fusion
[manual fusion] fusing EXP+SUM loops
[success] manual fusion completed
