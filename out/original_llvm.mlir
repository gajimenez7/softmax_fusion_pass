module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  ^bb9:  // pred: ^bb8
    %32 = llvm.getelementptr %arg1[%30] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %33 = llvm.load %32 : !llvm.ptr -> f32
    %34 = llvm.fsub %33, %18  : f32
    %35 = llvm.intr.exp(%34)  : (f32) -> f32
    %36 = llvm.getelementptr %arg6[%30] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %35, %36 : f32, !llvm.ptr
    %37 = llvm.add %30, %29  : i64
    llvm.br ^bb8(%37 : i64)
  ^bb10:  // pred: ^bb8
    %38 = llvm.mlir.constant(0 : index) : i64
    %39 = llvm.mlir.constant(1 : index) : i64
    llvm.br ^bb11(%38, %12 : i64, f32)
  ^bb11(%40: i64, %41: f32):  // 2 preds: ^bb10, ^bb12
    %42 = llvm.icmp "slt" %40, %14 : i64
    llvm.cond_br %42, ^bb12, ^bb13
  ^bb12:  // pred: ^bb11
    %43 = llvm.getelementptr %arg6[%40] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %44 = llvm.load %43 : !llvm.ptr -> f32
    %45 = llvm.fadd %41, %44  : f32
    %46 = llvm.add %40, %39  : i64
    llvm.br ^bb11(%46, %45 : i64, f32)
  ^bb13:  // pred: ^bb11
    %47 = llvm.mlir.constant(0 : index) : i64
    %48 = llvm.mlir.constant(1 : index) : i64
    llvm.br ^bb14(%47 : i64)
  ^bb14(%49: i64):  // 2 preds: ^bb13, ^bb15
    %50 = llvm.icmp "slt" %49, %14 : i64
    llvm.cond_br %50, ^bb15, ^bb16
  ^bb15:  // pred: ^bb14
    %51 = llvm.getelementptr %arg6[%49] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %52 = llvm.load %51 : !llvm.ptr -> f32
    %53 = llvm.fdiv %52, %41  : f32
    %54 = llvm.getelementptr %arg6[%49] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %53, %54 : f32, !llvm.ptr
    %55 = llvm.add %49, %48  : i64
    llvm.br ^bb14(%55 : i64)
  ^bb16:  // pred: ^bb14
    llvm.return
  }
